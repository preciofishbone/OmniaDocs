...
+ **Open Page as Dialog**: If you would like the News article to be opened in a dialogue, instead of in a new window, selevt this option. See below for an example.
...
Here's an example of a News artcicle displayed in a dialog (instead of in a new window):

.. Image:: news-dialog-example.png

You can open the page from here by clicking the link in low right corner.

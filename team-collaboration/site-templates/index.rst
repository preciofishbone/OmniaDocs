...
+ **Conversations**: This option is available for Office 365 Groups only. The default option is "Outlook". If "Teams" is selected, a Microsoft Team will be created connected to the Office 365 Group. If "Yammer" is selected, a Yammer group will be created related to the Office 365 Group.

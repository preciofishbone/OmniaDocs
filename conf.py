...
# -*- coding: utf-8 -*-
#
# Omnia documentation build configuration file, created by
# sphinx-quickstart on Fri May 22 13:06:21 2016.
#
...
latex_documents = [
  (master_doc, 'omnia.tex', 'Omnia Documentation',
   'Precio Fishbone', 'manual'),
]
...
man_pages = [
    (master_doc, 'omnia', 'Omnia Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'omnia', 'Omnia Documentation',
   author, 'omnia', 'Omnia Documentation',
   'Omnia Products'),
]
...
intersphinx_mapping = {'omnia': ('http://omnia-docs.readthedocs.io/en/latest', 'omnia.inv')}

...
+ **Delve Site Url**: If the "People" option in Quick Search should take the user to Delve instead of to the Enterprise Search Center, insert the Url to the Delve site here.
